...
void depth_first_search(std::vector<std::vector<std::vector<int>>>& solutions, std::vector<int>& queens,
                        int current_row, int board_size, std::vector<bool>& invalid_columns,
                        std::vector<bool>& invalid_forward_diagonals, std::vector<bool>& invalid_backward_diagonals)
{
    ...
    for (int col{}; col < board_size; ++col)
    {
        ...
        depth_first_search(solutions, queens, current_row + 1, board_size, invalid_columns, invalid_forward_diagonals,
...
std::vector<std::vector<std::vector<int>>> solve_queen_problem(int board_size)
{
    ...
    depth_first_search(solutions, queens, 0, board_size, invalid_columns, invalid_forward_diagonals,
                       invalid_backward_diagonals);
    return solutions;
}
