...
TEST(TestLetterCombinations, complex1)
{
    ...
    const std::vector<std::string> expected_output{
        "aptd", "apte", "aptf", "apud", "apue", "apuf", "apvd", "apve", "apvf", "aqtd", "aqte", "aqtf", "aqud", "aque",
        "aquf", "aqvd", "aqve", "aqvf", "artd", "arte", "artf", "arud", "arue", "aruf", "arvd", "arve", "arvf", "astd",
        "aste", "astf", "asud", "asue", "asuf", "asvd", "asve", "asvf", "bptd", "bpte", "bptf", "bpud", "bpue", "bpuf",
        "bpvd", "bpve", "bpvf", "bqtd", "bqte", "bqtf", "bqud", "bque", "bquf", "bqvd", "bqve", "bqvf", "brtd", "brte",
        "brtf", "brud", "brue", "bruf", "brvd", "brve", "brvf", "bstd", "bste", "bstf", "bsud", "bsue", "bsuf", "bsvd",
        "bsve", "bsvf", "cptd", "cpte", "cptf", "cpud", "cpue", "cpuf", "cpvd", "cpve", "cpvf", "cqtd", "cqte", "cqtf",
        "cqud", "cque", "cquf", "cqvd", "cqve", "cqvf", "crtd", "crte", "crtf", "crud", "crue", "cruf", "crvd", "crve",
        "crvf", "cstd", "cste", "cstf", "csud", "csue", "csuf", "csvd", "csve", "csvf"};
    EXPECT_EQ(letter_combinations_of_phone_numbers(input), expected_output);
}
