...
TEST(TestFindAllSumCombinations, simple1)
{
    ...
    std::vector<std::vector<int>> expected_output{{1, 1, 6}, {1, 2, 5}, {1, 7}, {2, 6}};
...
TEST(TestFindAllSumCombinations, simple3)
{
    ...
    std::vector<std::vector<int>> expected_output{{1, 2, 2}, {5}};
    EXPECT_EQ(find_all_combinations_brute_force(input, target), expected_output);
}
...
TEST(TestFindAllSumCombinations, simple4)
{
    ...
    std::vector<std::vector<int>> expected_output{{3, 8}, {4, 7}};
    EXPECT_EQ(find_all_combinations_brute_force(input, target), expected_output);
}
/////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////
...
{
    std::vector<int> input{14, 6,  25, 9,  30, 20, 33, 34, 28, 30, 16, 12, 31, 9,  9,  12, 34, 16, 25,
    ...
    std::vector<std::vector<int>> expected_output{
        {6, 6, 7, 8}, {6, 7, 14}, {6, 8, 13}, {6, 9, 12}, {6, 10, 11}, {6, 21},  {7, 8, 12}, {7, 9, 11}, {7, 20},
        {8, 8, 11},   {8, 9, 10}, {9, 9, 9},  {9, 18},    {10, 17},    {11, 16}, {13, 14},   {27}};
    EXPECT_EQ(find_all_combinations_backtracking(input, target), expected_output);
}
