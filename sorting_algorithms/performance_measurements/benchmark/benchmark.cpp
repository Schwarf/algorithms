...
template <typename T>
    requires std::is_arithmetic_v<T>
void std_stable_sort(std::vector<T>& v)
{
...
template <typename T>
    requires std::is_arithmetic_v<T>
void my_heap_sort(std::vector<T>& v)
{
    heap_sort(v);
}
...
template <typename T>
    requires std::is_arithmetic_v<T>
void my_insertion_sort(std::vector<T>& v)
{
    insertion_sort(v);
}
...
template <typename T>
    requires std::is_arithmetic_v<T>
void my_merge_sort(std::vector<T>& v)
{
    merge_sort(v);
}
...
template <typename T>
    requires std::is_arithmetic_v<T>
void my_quick_sort(std::vector<T>& v)
{
    quick_sort(v);
}
...
template <typename T>
    requires std::is_arithmetic_v<T>
void my_optimized_sort(std::vector<T>& v)
{
    optimized_sort(v, std::less());
}
