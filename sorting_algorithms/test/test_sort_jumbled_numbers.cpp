...
TEST(SortJumbledNumber1, simple4)
{
    ...
    std::vector<unsigned int> expected_result{11,    50,     3822,   9562,     8528,     39806,
                                              66634, 546691, 624620, 88631070, 800991114};
    EXPECT_EQ(expected_result, sort_jumbled_numbers(mapping, values));
}
...
TEST(SortJumbledNumber1, simple5)
{
    ...
    std::vector<unsigned int> values{87986890, 9191, 875,       88453,    481839962, 140741,  544020,
                                     8955228,  88,   9418050,   88238166, 47,        15621,   2318,
                                     2991,     128,  465455032, 457,      2482,      7344939, 770};
    std::vector<unsigned int> expected_result{128,     88,      47,      770,      875,      457,       15621,
                                              2318,    2991,    2482,    9191,     88453,    140741,    544020,
                                              7344939, 8955228, 9418050, 87986890, 88238166, 465455032, 481839962};
    EXPECT_EQ(expected_result, sort_jumbled_numbers(mapping, values));
}
