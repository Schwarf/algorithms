...
TEST_F(SetupBinaryTree, find_two_sum_in_binary_tree_not_found1)
{
...
TEST_F(SetupBinaryTree, find_two_sum_in_binary_tree_not_found2)
{
    constexpr int target{10};
    EXPECT_FALSE(find_target_two_sum(new TreeNode<int>(10), target));
}

TEST_F(SetupBinaryTree, find_two_sum_in_binary_tree_not_found3)
{
    constexpr int target{10};
...
TEST_F(SetupBinaryTree, find_two_sum_in_binary_tree_found2)
{
    constexpr int target{9};
    EXPECT_TRUE(find_target_two_sum(imbalanced_right_tree(), target));
}

TEST_F(SetupBinaryTree, find_two_sum_in_binary_tree_found3)
{
