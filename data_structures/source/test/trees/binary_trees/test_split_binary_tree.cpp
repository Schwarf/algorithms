...
///////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////
TEST_F(SetupBinaryTree, split_binary_tree_null_root2)
{
    // Tree:
    //     1
    //    / \
...
TEST_F(SetupBinaryTree, split_binary_tree_Positive_SimpleCut2)
{
    // Tree:
    //     1
    //    / \
    ...
    EXPECT_EQ(split_binary_tree2(root), 3);
}

TEST_F(SetupBinaryTree, split_binary_tree_Negative_OddTotal2)
{
    // Total = 5 (odd) => impossible
    auto root = small_tree_with_subtree_duplicates();
    EXPECT_EQ(split_binary_tree2(root), 0);
...
TEST_F(SetupBinaryTree, split_binary_tree_Negative_EvenButNoCut2)
{
    // Total = 54, target = 27, but no subtree sums to 27 => 0
    auto root = small_binary_tree_root();
    EXPECT_EQ(split_binary_tree2(root), 0);
...
TEST_F(SetupBinaryTree, split_binary_tree_Negative_LargerProvidedTree_NoCut2)
{
    // Subtree sums: left=6, right=10, leaves 2/3/4/5 => none is 9 => 0
    auto root = medium_tree_with_subtree_duplicates3();
    EXPECT_EQ(split_binary_tree2(root), 0);
...
TEST_F(SetupBinaryTree, SplitBinaryTree_Positive_GrandchildCut2)
{
    //       0
    //      / \
    //     1   1
...
TEST_F(SetupBinaryTree, SplitBinaryTree_Positive_LargerTree_SubtreeHalf2) {
    ...
    EXPECT_EQ(split_binary_tree2(root), 20);
}
