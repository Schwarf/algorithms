...
{
    const std::vector<std::vector<std::string>> input{{"EZE", "TIA"}, {"EZE", "AXA"}, {"AUA", "EZE"}, {"EZE", "JFK"},
                                                      {"JFK", "ANU"}, {"JFK", "ANU"}, {"AXA", "TIA"}, {"JFK", "AUA"},
                                                      {"TIA", "JFK"}, {"ANU", "EZE"}, {"ANU", "EZE"}, {"TIA", "AUA"}};
    const std::vector<std::string> expected_output{"JFK", "ANU", "EZE", "AXA", "TIA", "AUA", "EZE",
                                                   "JFK", "ANU", "EZE", "TIA", "JFK", "AUA"};
    EXPECT_EQ(expected_output, reconstruct_itinerary(input));
}
