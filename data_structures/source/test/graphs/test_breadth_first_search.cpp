...
TEST_F(SetupGraph, test_breadth_first_search_start_node1)
{
...
TEST_F(SetupGraph, test_breadth_first_search_start_node2)
{
	GraphNodePtr<int, int> start_node = nullptr;
	int start_node_id = 2;
	auto graph = get_graph(start_node_id, start_node);
...
TEST_F(SetupGraph, test_breadth_first_search_start_node7)
{
	GraphNodePtr<int, int> start_node = nullptr;
	int start_node_id = 7;
	auto graph = get_graph(start_node_id, start_node);
