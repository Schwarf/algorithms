...
{
    constexpr int n{10};
    std::vector<std::vector<int>> edges{{3, 5}, {3, 4}, {6, 8}, {1, 5}, {2, 8}, {6, 9}, {0, 2}, {7, 8}, {0, 4}, {3, 7},
                                        {8, 9}, {5, 8}, {3, 6}, {0, 6}, {1, 6}, {0, 1}, {0, 3}, {5, 6}, {1, 9}};
    std::vector<double> probabilities{0.72, 0.81, 0.18, 0.62, 0.96, 0.45, 0.19, 0.77, 0.1, 0.99,
                                      0.49, 0.25, 0.45, 0.68, 0.95, 0.61, 0.11, 0.72, 0.2};
...
TEST(TestPathWithMaximumProbabilityShortestPathFasterAlgo, simple1)
{
    constexpr int n{3};
    std::vector<std::vector<int>> edges{{0, 1}, {1, 2}, {0, 2}};
    std::vector<double> probabilities{0.5, 0.5, 0.2};
    ...
    EXPECT_DOUBLE_EQ(
        expected_result,
        max_probability_path_shortest_path_faster_algorithm(n, edges, probabilities, start_node, end_node));
}

TEST(TestPathWithMaximumProbabilityShortestPathFasterAlgo, simple2)
{
    constexpr int n{3};
    std::vector<std::vector<int>> edges{{0, 1}, {1, 2}, {0, 2}};
    std::vector<double> probabilities{0.5, 0.5, 0.3};
...
TEST(TestPathWithMaximumProbabilityShortestPathFasterAlgo, simple3)
{
    constexpr int n{3};
    std::vector<std::vector<int>> edges{{0, 1}};
    std::vector<double> probabilities{0.5};
...
TEST(TestPathWithMaximumProbabilityShortestPathFasterAlgo, medium1)
{
    constexpr int n{10};
    std::vector<std::vector<int>> edges{{3, 5}, {3, 4}, {6, 8}, {1, 5}, {2, 8}, {6, 9}, {0, 2}, {7, 8}, {0, 4}, {3, 7},
                                        {8, 9}, {5, 8}, {3, 6}, {0, 6}, {1, 6}, {0, 1}, {0, 3}, {5, 6}, {1, 9}};
