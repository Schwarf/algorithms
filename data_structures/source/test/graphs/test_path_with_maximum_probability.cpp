...
TEST(TestPathWithMaximumProbabilityBellmanFord, medium1)
{
    ...
    std::vector<double> probabilities{
        0.72, 0.81, 0.18, 0.62, 0.96, 0.45, 0.19, 0.77, 0.1, 0.99, 0.49, 0.25, 0.45, 0.68,
...
TEST(TestPathWithMaximumProbabilityShortestPathFasterAlgo, simple1)
{
    ...
    constexpr int end_node{2};
    constexpr double expected_result{0.25};
    EXPECT_DOUBLE_EQ(expected_result,
                     max_probability_path_shortest_path_faster_algorithm(n, edges, probabilities, start_node,
                         end_node));
}
