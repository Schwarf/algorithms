...
public:
    ...
    static std::tuple<std::vector<std::vector<std::pair<unsigned int, float>>>, std::vector<std::vector<float>>,
                      std::vector<std::vector<float>>, std::vector<std::vector<unsigned int>>>
    case1()
    {
        std::vector<std::vector<float>> adjacency_matrix = {{0.0, 2.5, 1.8, max_float, max_float},
                                                            {2.5, 0.0, 2.0, 3.1, max_float},
                                                            {1.8, 2.0, 0.0, max_float, 1.6},
                                                            {max_float, 3.1, max_float, 0.0, 2.3},
                                                            {max_float, max_float, 1.6, 2.3, 0.0}};
        std::vector<std::vector<std::pair<unsigned int, float>>> adjacency_list = {{{1, 2.5}, {2, 1.8}},
                                                                                   {{0, 2.5}, {2, 2.0}, {3, 3.1}},
                                                                                   {{0, 1.8}, {1, 2.0}, {4, 1.6}},
                                                                                   {{1, 3.1}, {4, 2.3}},
                                                                                   {{2, 1.6}, {3, 2.3}}};
        std::vector<std::vector<float>> weight_vectors_per_start_vertex = {
            {0.0, 2.0, 1.8, 2.3, 1.6}, {1.8, 0.0, 2.0, 2.3, 1.6}, {1.8, 2.0, 0.0, 2.3, 1.6},
            {1.8, 2.0, 1.6, 0.0, 2.3}, {1.8, 2.0, 1.6, 2.3, 0.0},
        };
        std::vector<std::vector<unsigned int>> parent_vectors_per_start_vertex = {
            {max_uint, 2, 0, 4, 2}, {2, max_uint, 1, 4, 2}, {2, 2, max_uint, 4, 2},
            {2, 2, 4, max_uint, 3}, {2, 2, 4, 4, max_uint},
        };
    ...
    static std::tuple<std::vector<std::vector<std::pair<unsigned int, int>>>, std::vector<std::vector<int>>,
                      std::vector<std::vector<int>>, std::vector<std::vector<unsigned int>>>
    case2()
    {
        ...
        std::vector<std::vector<std::pair<unsigned int, int>>> adjacency_list = {
            {{1, 4}, {3, 6}},          {{0, 4}, {2, 3}, {5, 8}, {6, 4}},
            {{1, 3}, {3, 2}, {6, 2}},  {{0, 6}, {2, 2}, {4, 4}},
            {{3, 4}, {7, 12}, {9, 7}}, {{1, 8}, {8, 5}, {9, 3}},
            {{1, 4}, {2, 2}},          {{4, 12}, {8, 4}},
            {{5, 5}, {7, 4}},          {{4, 7}, {5, 3}}};
        std::vector<std::vector<int>> weight_vectors_per_start_vertex = {
            {0, 4, 3, 2, 4, 3, 2, 4, 5, 7}, {4, 0, 3, 2, 4, 3, 2, 4, 5, 7}, {4, 3, 0, 2, 4, 3, 2, 4, 5, 7},
            {4, 3, 2, 0, 4, 3, 2, 4, 5, 7}, {4, 3, 2, 4, 0, 3, 2, 4, 5, 7}, {4, 3, 2, 4, 7, 0, 2, 4, 5, 3},
            {4, 3, 2, 2, 4, 3, 0, 4, 5, 7}, {4, 3, 2, 4, 7, 5, 2, 0, 4, 3}, {4, 3, 2, 4, 7, 5, 2, 4, 0, 3},
            {4, 3, 2, 4, 7, 3, 2, 4, 5, 0},
        };
        std::vector<std::vector<unsigned int>> parent_vectors_per_start_vertex = {
            {max_uint, 0, 1, 2, 3, 9, 2, 8, 5, 4}, {1, max_uint, 1, 2, 3, 9, 2, 8, 5, 4},
            {1, 2, max_uint, 2, 3, 9, 2, 8, 5, 4}, {1, 2, 3, max_uint, 3, 9, 2, 8, 5, 4},
            {1, 2, 3, 4, max_uint, 9, 2, 8, 5, 4}, {1, 2, 3, 4, 9, max_uint, 2, 8, 5, 5},
            {1, 2, 6, 2, 3, 9, max_uint, 8, 5, 4}, {1, 2, 3, 4, 9, 8, 2, max_uint, 7, 5},
            {1, 2, 3, 4, 9, 8, 2, 8, max_uint, 5}, {1, 2, 3, 4, 9, 9, 2, 8, 5, max_uint},
        };
