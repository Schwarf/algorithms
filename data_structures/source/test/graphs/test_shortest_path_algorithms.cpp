...
public:
    ...
    case1()
    {
        ...
        std::vector<std::vector<std::pair<unsigned int, float>>> adjacency_list = {{{1, 2.5}, {2, 1.8}},
                                                                                   ...
                                                                                   {{1, 3.1}, {4, 2.3}},
                                                                                   {{2, 1.6}, {3, 2.3}}};
        std::vector<std::vector<float>> distance_matrix = {{0.0, 2.5, 1.8, 5.6, 3.4},
                                                           {2.5, 0.0, 2.0, 3.1, 3.6},
                                                           {1.8, 2.0, 0.0, 3.9, 1.6},
                                                           {5.6, 3.1, 3.9, 0.0, 2.3},
                                                           {3.4, 3.6, 1.6, 2.3, 0.0}};
    ...
    case2()
    {
        ...
        std::vector<std::vector<int>> distance_matrix = {
            {0, 4, 7, 6, 10, 12, 8, 21, 17, 15},  {4, 0, 3, 5, 9, 8, 4, 17, 13, 11},
            {7, 3, 0, 2, 6, 11, 2, 18, 16, 13},   {6, 5, 2, 0, 4, 13, 4, 16, 18, 11},
            {10, 9, 6, 4, 0, 10, 8, 12, 15, 7},   {12, 8, 11, 13, 10, 0, 12, 9, 5, 3},
            {8, 4, 2, 4, 8, 12, 0, 20, 17, 15},   {21, 17, 18, 16, 12, 9, 20, 0, 4, 12},
            {17, 13, 16, 18, 15, 5, 17, 4, 0, 8}, {15, 11, 13, 11, 7, 3, 15, 12, 8, 0}};
