...
TEST(TestTaskScheduler, simple1)
{
    ...
    EXPECT_EQ(time_needed_for_scheduling_tasks(tasks, minimum_intervals_between_identical_tasks), expected_result);
}
...
{
    const std::vector<char> tasks{'A', 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K', 'L', 'M',
