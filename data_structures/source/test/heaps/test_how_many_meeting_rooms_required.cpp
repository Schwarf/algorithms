...
{
    std::vector<std::vector<int>> meetings{{1, 3}, {4, 6}, {1, 5}};
...
{
    std::vector<std::vector<int>> meetings{{1, 3}, {4, 6}, {1, 5}, {1, 2}};
...
{
    std::vector<std::vector<int>> meetings{{1, 3}, {4, 6}, {6, 7}, {0, 1}};
...
{
    std::vector<std::vector<int>> meetings{{1, 3}, {2, 4}, {3, 5}, {4, 6}};
    constexpr int expected_result{2};
    EXPECT_EQ(expected_result, how_many_meeting_rooms_required(meetings));
}
