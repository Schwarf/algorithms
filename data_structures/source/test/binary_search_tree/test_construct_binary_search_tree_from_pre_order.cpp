...
{
    // This is NOT a valid preorder for a BST under dup-right policy because "1" cannot appear after "3" in right
    // subtree of 2. Your helper will stop consuming when values no longer fit bounds, leaving suffix unconsumed.
