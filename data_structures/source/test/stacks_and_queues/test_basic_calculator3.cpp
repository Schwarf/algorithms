...
TEST(BasicCalculatorIIITest, ComplexExpression) { EXPECT_EQ(calculated3("(2+6* 3+5- (3*14/7+2)*5)+3"), -12); }

// Optional: Edge cases
TEST(BasicCalculatorIIITest, LargeNumbers) { EXPECT_EQ(calculated3("1000000*2+1"), 2000001); }
