...
TEST(TestMonotonicStack, simple_increasing1)
{
...
TEST(TestMonotonicStack, simple_increasing2)
{
...
TEST(TestMonotonicStack, simple_increasing3)
{
...
TEST(TestMonotonicStack, simple_decreasing1)
{
...
TEST(TestMonotonicStack, simple_decreasing2)
{
    std::vector<int> input{1, 4, 3, 4, 5, 6};
    auto decreasing_stack = MonotonicStack<int, false>();
    for (const auto& element : input)
...
TEST(TestMonotonicStack, simple_decreasing3)
{
...
TEST(TestMonotonicStackPair, simple_increasing1)
{
    std::vector<int> input{1, 2, 3, 4, 5, 6};
    auto increasing_stack = MonotonicStack<int, true>();
    for (const auto& element : input)
...
TEST(TestMonotonicStackPair, simple_increasing2)
{
    std::vector<int> input{1, 4, 3, 4, 5, 6};
    auto increasing_stack = MonotonicStack<int, true>();
    for (const auto& element : input)
...
TEST(TestMonotonicStackPair, simple_increasing3)
{
    std::vector<int> input{5, 4, 3, 4, 7, 6};
    auto increasing_stack = MonotonicStack<int, true>();
    for (const auto& element : input)
...
TEST(TestMonotonicStackPair, simple_decreasing1)
{
    std::vector<int> input{6, 5, 4, 3, 2, 1};
    auto decreasing_stack = MonotonicStack<int, false>();
    for (const auto& element : input)
...
TEST(TestMonotonicStackPair, simple_decreasing2)
{
    std::vector<int> input{1, 4, 3, 4, 5, 6};
    auto decreasing_stack = MonotonicStack<int, false>();
    for (const auto& element : input)
...
TEST(TestMonotonicStackPair, simple_decreasing3)
{
    std::vector<int> input{5, 4, 3, 4, 3, 2};
    auto decreasing_stack = MonotonicStack<int, false>();
    for (const auto& element : input)
