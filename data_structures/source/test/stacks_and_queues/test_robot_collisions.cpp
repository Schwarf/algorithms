...
TEST(TestRobotCollissions, complex1)
{
    std::vector<int> positions{
        7, 20, 78, 41, 59, 39, 88, 44, 66, 46, 84, 16, 92, 14, 82, 19, 69, 5, 56, 13, 11, 85, 3,
        28, 71, 9, 34, 47, 30, 54, 91, 68, 93, 23, 79, 77, 53, 4, 45, 75, 37, 26, 42, 76, 50, 73,
        99, 97, 55, 48, 10
    };
    std::vector<int> healths{
        232, 384, 466, 561, 603, 568, 515, 349, 99, 247, 726, 311, 781, 545, 567, 270, 10, 506,
...
{
    std::vector<int> positions{
        7, 50, 31, 41, 27, 87, 98, 63, 18, 94, 85, 60, 73, 79, 53, 100, 32, 26, 30, 43, 22, 69,
    ...
    std::vector<int> healths{
        587, 807, 457, 92, 509, 657, 233, 299, 681, 361, 193, 614, 628, 877, 130, 344, 975, 763,
