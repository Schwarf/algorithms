...
class SetupSinglyLinkedLists : virtual public testing::Test
{
public:
...
protected:
    ...
    template <typename T>
    NodePlusRP<T>*
    get_single_list_with_random_pointer_from_vector_and_value_pairs(const std::vector<T>& input,
                                                                    const std::unordered_map<T, T>& from_to)
    {
