...
// If the student at the front of the queue prefers the dish on the top of the stack, they will take it and leave the
// queue. Otherwise, they will leave it and go to the queue's end. This continues until none of the queue students want
// to take the top dish and are thus unable to eat. You are given two integer arrays students and dishes where dishes[i]
// is the type of the ith dish in the stack (i = 0 is the top of the stack) and students[j] is the preference of the jth
