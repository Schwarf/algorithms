...
//	auto ordered = avl_tree.get_vector_inorder();
	...
	std::shared_ptr<GraphNode<int, double>> node1(new GraphNode<int, double>(1,1.0));
	std::shared_ptr<GraphNode<int, double>> node2(new GraphNode<int, double>(2,2.0));
	std::shared_ptr<GraphNode<int, double>> node3(new GraphNode<int, double>(3,3.0));

	std::shared_ptr<GraphNode<int, double>> node4(new GraphNode<int, double>(4,4.0));
	std::shared_ptr<GraphNode<int, double>> node5(new GraphNode<int, double>(5,5.0));
	std::shared_ptr<GraphNode<int, double>> node6(new GraphNode<int, double>(6,6.0));
