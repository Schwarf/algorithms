...
// evaluations. Return the boolean result of evaluating the root node. A full binary tree is a binary tree where each
// node has either 0 or 2 children. A leaf node is a node that has zero children.
#include <stack>
