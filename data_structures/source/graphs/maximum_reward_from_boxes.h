...
// all the rewards in any open box and you can use the keys in it to open new boxes and you also can use the boxes you
// find in it.
//
...
int max_rewards_from_boxes(std::vector<int>& status, std::vector<int>& rewards, std::vector<std::vector<int>>& keys,
                           std::vector<std::vector<int>>& contained_boxes, std::vector<int>& initial_boxes)
{
    int n = status.size();
