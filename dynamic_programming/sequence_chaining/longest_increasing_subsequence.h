...
// A subsequence does not need to consist of contiguous elements, but the relative order of the selected elements must remain the same as in the input array.
 If multiple longest increasing subsequences exist, return any one of them.
#include <algorithm>
#include <vector>
