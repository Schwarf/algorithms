...
int main()
{
    std::vector<std::vector<std::string>> bad = {
        {"asas", "asasre"}, {"afdgfdas", "ashdha"}, {"dgfadsas", "qewqrehsasre"}};


    std::vector<std::vector<int>> cities = {{0, 0}, {1, 1}, {2, 0}, {3, 2},    {4, 1},
                                            {5, 3}, {6, 0}, {7, 2}, {27, -10}, {-6, -9}};

    std::vector<std::vector<double>> cities2 = {{82, 76}, {96, 44}, {50, 5}, {49, 8}, {13, 7},  {29, 89}, {58, 30},
                                                {84, 39}, {14, 61}, {2, 27}, {3, 89}, {56, 67}, {71, 91}, {80, 33},
                                                {49, 92}, {70, 7},  {66, 3}, {1, 44}, {88, 82}, {70, 88}};
