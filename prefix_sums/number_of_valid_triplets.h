...
// consecutive buildings out of the selected buildings can be of the same type. For example, given s = "001101", we
// cannot select the 1st, 3rd, and 5th buildings as that would form "011" which is not allowed due to having two
// consecutive buildings of the same type. Return the number of valid ways to select 3 buildings. LC 2222
