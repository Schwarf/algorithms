...
// and the bottom right corner (row2i, col2i). That is, add 1 to mat[x][y] for all row1i <= x <= row2i and col1i <= y <=
// col2i. Return the matrix mat after performing every query.
