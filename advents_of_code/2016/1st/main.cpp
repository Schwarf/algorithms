...
std::pair<int, int> check_locations_x(int start, int end, int y, std::unordered_set<std::pair<int, int>, hasher>& path,
                                      bool& found)
{
...
std::pair<int, int> check_locations_y(int start, int end, int x, std::unordered_set<std::pair<int, int>, hasher>& path,
                                      bool& found)
{
