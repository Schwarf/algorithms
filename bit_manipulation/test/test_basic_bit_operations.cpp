...
TEST(is_bit_position_valid, is_invalid1)
{
    ...
    std::string expected_message{"Bit position must be greater than 0 and smaller than " +
...
TEST(is_bit_position_valid, is_invalid3)
{
    ...
    std::string expected_message{"Provided bit position " + std::to_string(bit_position) +
