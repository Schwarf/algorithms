...
int insert_bit_sequence_into_bitstring(int bitstring, int bit_sequence, int left_start_position, int right_end_position)
{
	...
	return clear_bitstring_between_left_and_right | shift_bit_sequence_in_position;
}
