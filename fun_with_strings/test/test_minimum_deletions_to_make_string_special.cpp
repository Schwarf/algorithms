...
TEST(MinimumDeletionsTest, EmptyString) { EXPECT_EQ(minimumDeletions("", 0), 0); }
...
TEST(MinimumDeletionsTest, LargerKMakesNoDeletions) { EXPECT_EQ(minimumDeletions("aaaabbbcccd", 10), 0); }
