...
{
    const std::vector<unsigned int> left{};
    const std::vector<unsigned int> right{76, 18,  36, 52,  29, 58, 6,  68, 61, 63, 57, 79, 70, 86, 98, 83, 21,
                                          0,  14,  90, 101, 64, 78, 16, 60, 89, 71, 67, 65, 92, 96, 55, 12, 10,
                                          30, 104, 45, 51,  9,  1,  72, 38, 94, 73, 87, 24, 37, 19, 80, 42, 28,
                                          88, 7,   44, 74,  75, 8,  62, 77, 4,  48, 82, 13, 47, 40};
