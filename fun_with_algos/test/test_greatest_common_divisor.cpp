...
TEST(TestGreatestCommonDivisor, simple1) {
    constexpr int a{100};
    constexpr int b{15};
...
TEST(TestGreatestCommonDivisorRecursive, simple1) {
    constexpr int a{100};
    constexpr int b{15};
    constexpr int expected_gcd{5};
    EXPECT_EQ(expected_gcd, greatest_common_divisor_recursive(a, b));
}

TEST(TestGreatestCommonDivisorRecursive, PositiveInputs) {
    constexpr int a = 100;
    constexpr int b = 15;
    constexpr int expected_gcd = 5;
    EXPECT_EQ(expected_gcd, greatest_common_divisor_recursive(a, b));
...
TEST(TestGreatestCommonDivisorRecursive, NegativeInputs) {
    constexpr int a = -100;
    constexpr int b = -50;
    constexpr int expected_gcd = 50;
    EXPECT_EQ(expected_gcd, greatest_common_divisor_recursive(a, b));
...
TEST(TestGreatestCommonDivisorRecursive, MixedSignInputs) {
    constexpr int a = 35;
    constexpr int b = -5;
    constexpr int expected_gcd = 5;
    EXPECT_EQ(expected_gcd, greatest_common_divisor_recursive(a, b));
...
TEST(TestGreatestCommonDivisorRecursive, ZeroAndPositive) {
    constexpr int a = 0;
    constexpr int b = 20;
    constexpr int expected_gcd = 20;
    EXPECT_EQ(expected_gcd, greatest_common_divisor_recursive(a, b));
...
TEST(TestGreatestCommonDivisorRecursive, PositiveAndZero) {
    constexpr int a = 45;
    constexpr int b = 0;
    constexpr int expected_gcd = 45;
    EXPECT_EQ(expected_gcd, greatest_common_divisor_recursive(a, b));
...
TEST(TestGreatestCommonDivisorRecursive, LargeNumbers) {
    constexpr long long a = 1234567890LL;
    constexpr long long b = 987654321LL;
    constexpr long long expected_gcd = 9LL;
    EXPECT_EQ(expected_gcd, greatest_common_divisor_recursive(a, b));
...
TEST(TestGreatestCommonDivisorRecursive, UnsignedTypes) {
    constexpr unsigned int a = 100u;
    constexpr unsigned int b = 10u;
    constexpr unsigned int expected_gcd = 10u;
    EXPECT_EQ(expected_gcd, greatest_common_divisor_recursive(a, b));
...
TEST(TestGreatestCommonDivisorRecursive, SmallNumbers) {
    constexpr short a = 8;
    constexpr short b = 2;
    constexpr short expected_gcd = 2;
    EXPECT_EQ(expected_gcd, greatest_common_divisor_recursive(a, b));
...
TEST(TestGreatestCommonDivisorRecursive, PrimeNumbers) {
    constexpr int a = 13;
    constexpr int b = 17;
    constexpr int expected_gcd = 1;
    EXPECT_EQ(expected_gcd, greatest_common_divisor_recursive(a, b));
...
TEST(TestGreatestCommonDivisorRecursive, SameNumbers) {
    constexpr int a = 42;
    constexpr int b = 42;
    constexpr int expected_gcd = 42;
    EXPECT_EQ(expected_gcd, greatest_common_divisor_recursive(a, b));
